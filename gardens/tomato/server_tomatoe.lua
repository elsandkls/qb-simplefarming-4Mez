...
RegisterServerEvent('qb-simplefarming:tomatoespicking', function()
    ...
    TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items[Config.Inventory['Tomatoes'].db_obj], "add")
    TriggerClientEvent('QBCore:Notify', source, Config.Alerts['farm_grab'].." "..tompicking.." "..Config.Alerts['tomatoes_color'])
end)    
